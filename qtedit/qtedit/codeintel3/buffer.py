...
from codeintel3.util import isident, indent, banner, markup_text
...
class Buffer(object):
    ...
    def preceding_trg_from_pos(self, pos, curr_pos):
        ...
        - Only consider a *completion* (i.e. TRG_FORM_CPLN) trigger point
          if repr(pos' is in range. I.e.:
                sys.pat<|>h         # consider the )sys.' trigger
                os.path.join("<|>   # do not consider the repr(os.path.' trigger
