...
# (qtedit's Python-3 port: styles.py is copied to qtedit/qtedit/styles.py,
# a plain top-level import instead of the original's sys.path dance into
# a sibling src/schemes/ directory -- see the plan doc's codeintel3
# Python-3 port phase.)
import styles
...
#   import warnings
#   from codeintel3.common import CodeIntelDeprecationWarning
...
class CILEDriver(object):
    ...
    def scan(self, request):
        ...
        return value should be str string, i.e. NOT an encoded byte
