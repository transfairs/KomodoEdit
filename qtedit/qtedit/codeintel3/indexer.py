...
from codeintel3.database.langlib import LangDirsLib
from codeintel3.database.multilanglib import MultiLangDirsLib
...
##            allowed in this mode.
    ...
    def pause(self):
        ...
        #TODO: shouldn't this be repr(self.add_request)?
...
##                    reason = "stopped"
                    ...
                    # termination in repr(self.finalize) it is possible that
                    # an ongoing request fails (Manager finalization
                    # destroys the repr(mgr.db) instance). Don't bother
