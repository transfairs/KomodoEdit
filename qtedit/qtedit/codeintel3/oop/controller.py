...
from codeintel3.common import EvalController
import logging
...
class OOPEvalController(EvalController):
    ...
    def setup_log(self):
        if not self.desc:
            desc = {codeintel3.common.TRG_FORM_CPLN: "completions",
                    codeintel3.common.TRG_FORM_CALLTIP: "calltip",
                    codeintel3.common.TRG_FORM_DEFN: "definition",
                   }.get(self.trg.form, "???")
            self.set_desc(desc)
